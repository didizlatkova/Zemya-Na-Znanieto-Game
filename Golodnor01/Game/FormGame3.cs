            ...
            if (!isOver && numberTries < 3)
            {
                ...
                else if (listBlank.Contains(match))
                {
                    ...
                    if (selectedMatch != null)
                    {
                        ...
                        if (numberTries == 3)
                        {
                            if (listBlank.Contains(pictureMatchH1) && listBlank.Contains(pictureMatchH6)
                                && listBlank.Contains(pictureMatchH7) && listBlank.Contains(pictureMatchV7)
                                ...
                                && listBlank.Contains(pictureMatchH12) && listBlank.Contains(pictureMatchV8)
                                && listBlank.Contains(pictureMatchV9) && listBlank.Contains(pictureMatchV3) ||
                            listBlank.Contains(pictureMatchH3) && listBlank.Contains(pictureMatchH2)
                                && listBlank.Contains(pictureMatchH7) && listBlank.Contains(pictureMatchV7)
                                && listBlank.Contains(pictureMatchH10) && listBlank.Contains(pictureMatchV10)
                                && listBlank.Contains(pictureMatchH11) && listBlank.Contains(pictureMatchV11)
                                && listBlank.Contains(pictureMatchH12) && listBlank.Contains(pictureMatchV8)
                                && listBlank.Contains(pictureMatchV12) && listBlank.Contains(pictureMatchV2))
                            {
...
@"Целта на играта е да преместите само три кибритени клечки така, че да се получат три еднакви квадрата.";
            Restart();
        }
        ...
        private void labelSkip_Click(object sender, EventArgs e)
        {
            if (!isOver)
            {
                ...
                for (int i = 0; i < this.Controls.Count; i++)
                {
                    if (this.Controls[i] is PictureBox && this.Controls[i].Name.StartsWith("pictureMatch"))
                    {
                        if (this.Controls[i].Name == "pictureMatchH1" || this.Controls[i].Name == "pictureMatchH6"
                            || this.Controls[i].Name == "pictureMatchV3" || this.Controls[i].Name == "pictureMatchH7"
                            || this.Controls[i].Name == "pictureMatchV11" || this.Controls[i].Name == "pictureMatchH10"
                            || this.Controls[i].Name == "pictureMatchV7" || this.Controls[i].Name == "pictureMatchH11"
                            || this.Controls[i].Name == "pictureMatchV8" || this.Controls[i].Name == "pictureMatchH12"
                            || this.Controls[i].Name == "pictureMatchV9" || this.Controls[i].Name == "pictureMatchV10")
                        {
                            listBlank.Add(this.Controls[i]);
                        }
                        else
        ...
        private void FormGame3_FormClosed(object sender, FormClosedEventArgs e)
        {
            Forms.formMain.FormMain_FormClosed(sender, e);
        }

        private void FormGame3_FormClosing(object sender, FormClosingEventArgs e)
        {
