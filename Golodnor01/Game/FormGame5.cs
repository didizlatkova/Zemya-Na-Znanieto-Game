...
namespace Golodnor01
{
    public partial class FormGame5 : Form
    {
            ...
            for (int i = 0; i < this.Controls.Count; i++)
            {
                if (this.Controls[i] is PictureBox && this.Controls[i].Name.StartsWith("pictureMatch"))
                {
                    if (this.Controls[i].Name == "pictureMatchH9" || this.Controls[i].Name == "pictureMatchV9"
                        ...
                        || this.Controls[i].Name == "pictureMatchH11" || this.Controls[i].Name == "pictureMatchH12"
                        || this.Controls[i].Name == "pictureMatchH11" || this.Controls[i].Name == "pictureMatchV7"
                        || this.Controls[i].Name == "pictureMatchH7" || this.Controls[i].Name == "pictureMatchH12"
                        || this.Controls[i].Name == "pictureMatchH8" || this.Controls[i].Name == "pictureMatchV8"
                         || this.Controls[i].Name == "pictureMatchV11" || this.Controls[i].Name == "pictureMatchV12")
                    {
            ...
            if (!isOver && numberTries < 2)
            {
                ...
                else if (listBlank.Contains(match))
                {
                    ...
                    if (selectedMatch != null)
                    {
                        ...
                        if (numberTries == 2)
                        {
                            if (listBlank.Contains(pictureMatchH3) && listBlank.Contains(pictureMatchV5)
                                && listBlank.Contains(pictureMatchH8) && listBlank.Contains(pictureMatchV8)
                                && listBlank.Contains(pictureMatchH9) && listBlank.Contains(pictureMatchV7)
                                && listBlank.Contains(pictureMatchH10) && listBlank.Contains(pictureMatchV10)
                                && listBlank.Contains(pictureMatchH11) && listBlank.Contains(pictureMatchH12)
                                 && listBlank.Contains(pictureMatchV12) && listBlank.Contains(pictureMatchV11))
                            {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Forms.formGameMessage.labelGameMessage.Text = @"Дванадесет кибритени клечки са подредени така, че да образуват три 
еднакви квадрата. Целта на играта е да преместите само две кибритени клечки така, че да се получи часът четири и половина.";            
            Restart();
        }
        ...
        private void labelSkip_Click(object sender, EventArgs e)
        {
            if (!isOver)
            {
                ...
                for (int i = 0; i < this.Controls.Count; i++)
                {
                    if (this.Controls[i] is PictureBox && this.Controls[i].Name.StartsWith("pictureMatch"))
                    {
                        if (this.Controls[i].Name == "pictureMatchH3" || this.Controls[i].Name == "pictureMatchH8"
                            || this.Controls[i].Name == "pictureMatchV5" || this.Controls[i].Name == "pictureMatchV7"
                            || this.Controls[i].Name == "pictureMatchH9" || this.Controls[i].Name == "pictureMatchH10"
                            || this.Controls[i].Name == "pictureMatchH11" || this.Controls[i].Name == "pictureMatchH12"
                            || this.Controls[i].Name == "pictureMatchV11" || this.Controls[i].Name == "pictureMatchV12"
                            || this.Controls[i].Name == "pictureMatchV10" || this.Controls[i].Name == "pictureMatchV8")
                        {
                            listBlank.Add(this.Controls[i]);
                        }
                        else
        ...
        private void FormGame5_FormClosed(object sender, FormClosedEventArgs e)
        {
            Forms.formMain.FormMain_FormClosed(sender, e);
        }

        private void FormGame5_FormClosing(object sender, FormClosingEventArgs e)
        {
