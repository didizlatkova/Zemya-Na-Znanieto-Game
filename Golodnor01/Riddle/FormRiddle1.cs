...
{
    public partial class FormRiddle1 : Form
    {
        public FormRiddle1()
        {
            InitializeComponent();
        ...
        private void FormRiddle1_Load(object sender, EventArgs e)
        {
            // Set icon
            ...
            Forms.formGameMessage.labelGameMessage.Text = @"Целта на играта е да сметнете уравнението. 
        ...
        private void FormRiddle1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Forms.formMain.FormMain_FormClosed(sender, e);
        }

        private void FormRiddle1_FormClosing(object sender, FormClosingEventArgs e)
        {
