...
{
    public partial class FormDiff5 : Form
    {
        public FormDiff5()
        {
            InitializeComponent();
        ...
        private void FormDiff5_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff5_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff5_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff5_FormClosed(object sender, FormClosedEventArgs e)
        {
