...
{
    public partial class FormDiff1 : Form
    {
        public FormDiff1()
        {
            InitializeComponent();
        ...
        // Make circles appear when a diff is found
        ...
        private void FormDiff1_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff1_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff1_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff1_FormClosed(object sender, FormClosedEventArgs e)
        {
