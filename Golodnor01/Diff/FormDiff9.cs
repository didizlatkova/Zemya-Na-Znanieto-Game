...
{
    public partial class FormDiff9 : Form
    {
        public FormDiff9()
        {
            InitializeComponent();
        ...
        private void FormDiff9_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff9_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff9_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff9_FormClosed(object sender, FormClosedEventArgs e)
        {
