...
{
    public partial class FormDiff2 : Form
    {
        public FormDiff2()
        {
            InitializeComponent();
        ...
        private void FormDiff2_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff2_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff2_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff2_FormClosed(object sender, FormClosedEventArgs e)
        {
