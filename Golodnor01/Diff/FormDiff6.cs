...
{
    public partial class FormDiff6 : Form
    {
        public FormDiff6()
        {
            InitializeComponent();
        ...
        private void FormDiff6_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff6_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff6_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff6_FormClosed(object sender, FormClosedEventArgs e)
        {
