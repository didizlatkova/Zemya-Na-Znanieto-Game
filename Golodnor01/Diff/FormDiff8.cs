...
{
    public partial class FormDiff8 : Form
    {
        public FormDiff8()
        {
            InitializeComponent();
        ...
        private void FormDiff8_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff8_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff8_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff8_FormClosed(object sender, FormClosedEventArgs e)
        {
