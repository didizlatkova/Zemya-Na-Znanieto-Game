...
{
    public partial class FormDiff4 : Form
    {
        public FormDiff4()
        {
            InitializeComponent();
        ...
        private void FormDiff4_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff4_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff4_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff4_FormClosed(object sender, FormClosedEventArgs e)
        {
