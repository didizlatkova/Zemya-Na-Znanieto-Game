...
{
    public partial class FormDiff3 : Form
    {
        public FormDiff3()
        {
            InitializeComponent();
        ...
        private void FormDiff3_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff3_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff3_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff3_FormClosed(object sender, FormClosedEventArgs e)
        {
