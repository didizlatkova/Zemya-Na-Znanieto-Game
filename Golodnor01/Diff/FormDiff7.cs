...
{
    public partial class FormDiff7 : Form
    {
        public FormDiff7()
        {
            InitializeComponent();
        ...
        private void FormDiff7_Load(object sender, EventArgs e)
        {
            // Set icon
        ...
        private void FormDiff7_Click(object sender, EventArgs e)
        {
        ...
        private void FormDiff7_FormClosing(object sender, FormClosingEventArgs e)
        {
            Forms.formMain.FormMain_FormClosing(sender, e);
        }

        private void FormDiff7_FormClosed(object sender, FormClosedEventArgs e)
        {
